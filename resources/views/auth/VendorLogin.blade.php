        ...
        <div class="container">
            ...
            <div class="container">
                ...
                {{-- -------------------------------------- --}}
                            ...
                            <form method="POST" action='{{ url("login/vendor") }}' aria-label="{{ __('Login') }}">
                                ...
                                @csrf
                                  ...
                                  @if (Route::has('vendor.forget.password.get'))
                                  <span class="psw forgot_pwd"><a href="{{ route('vendor.forget.password.get') }}">
                                          {{ __('Forget password?') }}
                                  ...
                                  <span class="signup">Don't have an account? <a
                                          href="{{ route('vendor_register') }}">Sign up</a></span>
