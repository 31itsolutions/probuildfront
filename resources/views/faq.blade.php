...
<body style="background: #E5E5E5;">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="offset-md-2 col-md-8" style="background: #FFFFFF;">
              <h3 class="text-center" style="margin-left: 18px">FAQ</h3>
              <hr>
      ...
      <div class="panel panel-light" style = "border-color:none;">
  ...
  <a href="#" class="list-group-item"> {{ $data['faq']['title_description'] }}</a>
