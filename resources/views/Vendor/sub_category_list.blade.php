                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            @if (Auth::guard('customer')->check())
                                ...
                                <li>
                                    <b><a href="{{ route('customer') }}" style="color:black !important;"
                                            class="logined">
                                            <i class="bi bi-box-arrow-in-right"></i> &nbsp; Customer</a></b>
                                </li>
                                <li class="add_business_logined ">
                                    <b><a href="{{ route('vendor_package_monthly') }}" style="color:black !important;">
                                            Submit Tendor</a></b>
                                </li>
                            @elseif(Auth::guard('vendor')->check())
                                {{-- <div class="row"> --}}
                                <li>
                                    <b><a href="{{ route('vendor') }}" style="color:black !important;" class="logined">
                                            <i class="bi bi-box-arrow-in-right"></i> &nbsp; Vendor</a></b>
                                </li>
                                @if ($data['add_business'] = true)
                                    <li class="add_business_logined">
                                        <b><a href="{{ route('vendor') }}" style="color:black !important;">
                                                Add Buisness</a></b>
                                    </li>
...
@endforeach
                                    ...
                                    <div class="dropdown cat_dropdown" style="text-align: left;">
                                        <button class="btn btn-default  cat_button" id="categoryButton"
                                            type="button" data-toggle="dropdown">Category <i
...
<ul class="categories1">
    ...
    <div class="filter_flex mb-5">

        <h1>Search for Results “{{ $data['category_name']->sub_category }}”</h1>
        {{-- <div class=  "filter_button">
                             <div class = "filter_bg">
                            <h1 onclick="myFunction()" type = "button" class="modal__trigger"> <i class="fas fa-filter"></i>
                            Filter
                            </h1>
                            </div>
                              ...
                              <h1 onclick="openCity(event, 'probuild')" class="tablinks">Probuild Verified</h1>
                                ...
                                <div id = "rating" class = "tabcontent">
                                        ...
                                        <div class = "rate_check">
                                        <input type="radio" name="rating_search" name  ="rate_value" checked value="1">
                                        <label>1 <i class="fa fa-star" aria-hidden="true"></i> &above</label>
                                        </div>
                                      </div>
...
<button class = "btn btn-primary" type = "submit">Apply</button>
    ...
    <div class="business_css for_tag mt-4" style="height: auto;">
        <div class="Recommended">
                                ...
                                <div class="col-12 col-lg-3 col-md-4 col-sm-6 col-6 b_width ">
                                    <div class="" data-aos=" fade-up" data-aos-delay="50">
                                        <div class="about-col">
                                            ...
                                            <div class="available_tag "
                                                style="position: absolute;z-index: 100;background-color: <?php echo $color; ?>;width: 38%;text-align: center;top: 4%;">
                                                {{ $val['status'] ? 'Available' : 'Not Available' }}</div>
