...
<div class  = "container ">
     ...
     <div class="row">
        ...
        <a class = "active_type" href = "{{route('vendor_package')}}">Yearly</a>

        <a class = "y" href = "{{route('vendor_package_monthly')}}">Monthly</a>
        </div>
...
{{-- @if (($plan_detail->package_name == $item->package_name) &&  ($plan_detail->package_type =="Y"))
   (Current Package)
@endif --}}
        ...
        @if ($item->gross_type == "M" && $item->gross_period>0)
           <p>
        {{$item->gross_period}} Months free
           </p>      
        @endif
