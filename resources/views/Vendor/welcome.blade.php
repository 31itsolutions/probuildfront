                        ...
                        <div class="col-lg-12 filter_header ">
                            ...
                            <div class="drop_one">
                                ...
                                <div class="looking">
                                    ...
                                    <input type="address" name="looking" style="color: black" class="searchText_1 looking_text"
                            ...
                            <div class="drop_one ">
                                ...
                                <div class="filter_location">
                                    ...
                                    <input type="address" name="location" style="color: black"  class="searchText " placeholder="Location"
                                        autocomplete="on">
                                </div>
                                {{-- </fieldset> --}}
                            </div>
