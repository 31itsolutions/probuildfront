...
.logo_type p span {
    font-size: 23px!important;
        ...
        <div class="top_left_logo company_flex">
            ...
            <div class="logo_bottom">
    @if ($vendor_id->profile_image != null)
        <img  style="margin-top:20px;" class="logo-bottom" src="{{ asset('upload_images/vendor_profile/' . $vendor_id->profile_image) }}" alt="No image" style="width: 300px; height: 400px;">
    @else
        <img style="margin-top:20px;" class="logo-bottom" src="{{ asset('assets/images/default.png') }}" alt="No image" style="width: 300px; height: 400px;">
    @endif
</div>

            <div class="logo_info" style="margin-left: -2px;">
                <div class="logo_type">
                    <p style="color: black; font-size: 20px;"><span>{{ $data['products'][0]->sub_category }}</span></p>
                </div>
                <div class="logo_name mt-1 company_logo_name">
                    <h1 style="font-size: 24px;">{{ $business->business_title }}</h1>
                ...
                <div class="logo_location" style="padding-top: 10px!important;">
                    <!-- <h1 style="font-size: 24px;"><i class="bi bi-geo-alt " style="color:#F4E059; font-size: 22px!important;"></i>{{ $business->location }},
                        {{ $business->city }}, {{ $business->country }}</h1> -->
                         <p style="font-size: 14px; font-weight: bold; color: #F4E059;margin-top:15px;">
            <i class="bi bi-geo-alt" style="font-size: 16px!important;"></i>
            {{ $business->location }}, {{ $business->city }}, {{ $business->country }}
        </p>
                </div>
                <div class="logo_rate" style="margin-top: -23px;">
                    ...
                    <span class="count count_cy" style="font-size: 16px; margin-left: 10px; margin-top: 8px!important;">
                ...
                <div class="top_right top">
                    <div class="">
                    <h1 class="btn rt shadowbox" style="width:150px;margin-top: 23px;background-color: #f4e059;font-weight: 600;padding-left: 19px;padding-right: 17px;text-decoration: none;"><a  style="color:black;text-align:center;" href="{{ route('request_call', $business->id) }}">Request Call</a></h1>
                    </div>
                    <div class="">
                    ...
                    <h1 class="btn brow_btn btnb shadowbox" style="width:150px;margin-top: 7px;background-color: #f4e059;color:black;font-weight: 600;text-decoration: none;"  data-backdrop="false"><a        href="#rfq" style="color:black;text-align:center;" >Request Quotation</h1></a>
                    </div>
...
.card {
  border-radius: 25px;
  background-color: #FFF;
  overflow: hidden; /* Ensure content doesn't overflow from curved edges */
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
  transition: box-shadow 0.3s ease;
  border-radius: 25px 25px 25px  25px!important; /* Apply rounded top edges to image section */
  height: 400px;
...
width: calc(50% - 16px)!important; /* Adjust width for two cards in a row with some spacing */
margin-bottom: 20px; /* Add some space between rows of cards */
...
.image-content {
  ...
  height: 200px;
  border-radius: 25px 25px 0 0; /* Apply rounded top edges to image section */
}
...
width: 100%!important; /* Adjust width for two cards in a row with some spacing */
margin-bottom: 20px; /* Add some space between rows of cards */
                    ...
                    <div class="card">
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img class="card-img" src="{{ asset('upload_images/business_image/' . $business->business_image) }}" alt="">
                            </div>
                        </div>
                        <div class="card-content">
                            <h2 class="name">{{ $item->product_name }}</h2>
                            <p><b>{{ $item->product_price_from }} - {{ $item->product_price_to }}</b></p>
...
<div class="slide-container swiper">
            <div class="slide-content">
                ...
                @foreach ($data['products'] as $key => $item)
                    <div class="card swiper-slide ssize"  >
                        <!-- <div class="image-content" style=""> -->
                        <div class="image-content" style="background-image: url('{{ asset('upload_images/business_image/' . $business->business_image) }}'); background-size: cover;object-fit: cover; background-position: center; background-repeat: no-repeat;height:200px;">

                        </div>


                        <div class="card-content" style="margin-top:-25px;" >
                            <h1 class="pname">{{ $item->product_name }}</h1>
                            <p class="price" > {{ $item->product_price_from }} BD - {{ $item->product_price_to }} BD</h5>
                            <p class="description" style="text-align: center;!important;margin-top:-8px;">{{ $item->product_description }}</p>
  ...
  <div class="right_tl containerss" style="display:none;">
                    ...
                    <div class="mge_row" id="rfq">
                            ...
                            <div class="mge_btn">
                                ...
                                <h1 class="shadowbox" data-toggle="modal" data-target="#myModal" data-backdrop="false"><button type="button" class="btn " >View Brochure</button></h1>
...
<!-- ====================MOBILE VIEW Brochure end==================== -->
 ...
 <div class="u_d ml-2 mx-5 " >
                                                    ...
                                                    <div class="review_flex">
                                                        ...
                                                        <div class="u_name">
                                                            <h1  style="padding-top:5px;">{{ $item_one->customer_name }}</h1>
                                                        </div>
                                                        <div class="u_date">
                                    ...
                                    @empty
                                    <p class="company_review"  style=" text-align: center;">No Reviews Found...!</p>  
                                    @endforelse
                                </div>
