                        ...
                        <div class="col-lg-12 filter_header ">
                            ...
                            <div class="drop_one ">
                                ...
                                <div class="filter_location">
                                    ...
                                    <input type="address" name="location" style="color: black" class="searchText "
                                        placeholder="Location" autocomplete="on">
                                </div>
                                {{-- </fieldset> --}}
                            </div>
...
@endforeach
   ...
   <div class="modal-dialog modal-dialog-login  modal-dialog-centered">
    ...
    <ul class="categories1">
        ...
        @else
            <h1 class="btn btnb"
                style="margin-top: 23px;background-color: #f4e059;font-weight: 600;padding-left: 19px;padding-right: 17px;margin-left: 20%;margin-right: 20%;text-decoration: none;display:none;">
                            ...
                            <div class="col-6 col-sm-6 p-2 ">
                                @foreach ($data['home_category_1'] as $val)
                                    <div class="iconhover">
                                        <img src="{{ asset('upload_images/category_home_image/' . $val->background_image) }}"
                                            class="image2" style="border-radius: 8px;">
                                        <div class="overlay" style="background-color: rgba(244, 224, 89, 0.53);">
                                            <a href="{{ route('subCategorys', $val->sub_category) }}"
                                                class="overicon">
                                                <img class="logo-img"
                                                    src="{{ asset('upload_images/category_home_image/' . $val->centered_image) }}"
