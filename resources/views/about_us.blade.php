            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <li>
                     ...
                     <li class="add_business_logined">
                                    <b><a class="header-btn" href="{{ route('vendor') }}">
                                            Add Business</a></b>
                                </li>
                    @else
                    <li>
...
<body style="background: #E5E5E5;">
        ...
        <div class="container">
          ...
          <div class="row mx-2">
            ...
            <div class="offset-md-2 col-md-8 about_body" style="background: #FFFFFF;">
              <h3>About Us</h3>
              <hr>
              <!-- <h3>Message Us</h3> -->
                <form action="{{ route('addFAQ_us') }}" id="contactForm_data" method="POST" enctype="multipart/form-data">
                   @csrf
                      <div class="col-md-12 about_d">
                          <p>{{ $data['about_us']['title_description'] }}</p>
