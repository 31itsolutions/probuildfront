<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click"
                    ...
                    <ul class="nav navbar-nav float-right">
                      ...
                      {{--   <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">{{$admin->name}}</span><span
                                        class="user-status text-muted">Available</span></div><span>
                                        ...
                                        @else
                                           <img class="round"
                                        src="{{asset('storage/admin_profile/'. $admin->profile)}}" alt="avatar"
                                        height="40" width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item"
                                    href="{{route('admin_profile')}}"><i class="bx bx-user mr-50"></i> Edit Profile</a>
                                <div class="dropdown-divider mb-0"></div>


                                <a class="dropdown-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();" style=""><i class="bx bx-power-off mr-50"></i>
                                    Logout</a>
    ...
    <!-- BEGIN: Main Menu-->
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow bg-secondary" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html">
                        <div class="brand-logo">
                            <img class="logo" width="66px" height="106px" viewbox="0 0 66 86" version="1.1" src="{{ asset('assets/images/logo.png') }}" 
                              
                            />
                        </div>
                        <h2 class="brand-text mb-0 ml-2">Pro build</h2>
                    </a></li>
        ...
        <div class="main-menu-content bg-secondary">
            <ul class="navigation navigation-main bg-secondary" id="main-menu-navigation" data-menu="menu-navigation"
                data-icon-style="lines">

               
                <li class=" navigation-header text-truncate"><span data-i18n="Apps">Details</span>
                </li>
                <li class=" nav-item"><a href="{{ route('admin.home') }}"><i class="" data-icon="envelope-pull"></i><span
                    class="menu-title text-truncate text-light" data-i18n="User">Home</span></a>
                </li>
  
  
  
                
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Invoice">Category</span></a>
                      <ul class="menu-content">
                          <li><a class="d-flex align-items-center" href="{{route('main_category')}}"><i
                                      class="bx bx-right-arrow-alt "></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Main Category</span></a>
                          </li>
                          <li><a class="d-flex align-items-center" href="{{route('sub_category')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice">Sub-Category</span></a>
                          </li>
                  ...
                  {{-- <li class=" nav-item"><a href="app-chat.html"><i class="" data-icon="comments"></i><span
                              class="menu-title text-truncate" data-i18n="User">User Analytics</span></a>
                  </li> --}}
                  <li class=" nav-item"><a href="{{ route('create_vendor') }}"><i class="" data-icon="check-alt"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Vendor">Add Vendor</span></a>
                  </li>
             
  
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Invoice">Manage Accounts</span></a>
                      <ul class="menu-content">
                          <li><a class="d-flex align-items-center" href="{{route('user_accounts')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">User Accounts</span></a>
                          </li>
                          <li><a class="d-flex align-items-center" href="{{route('vendor_accounts')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice">Vendor Accounts</span></a>
                          </li>
                  ...
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Invoice">Package Details</span></a>
                      <ul class="menu-content">
                          <li><a class="d-flex align-items-center" href="{{ route('PackageDetail') }}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Manage Packages</span></a>
                          </li>
                         ...
                         <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Invoice">Update Design</span></a>
                      <ul class="menu-content">
                          <li><a class="d-flex align-items-center" href="{{route('create_image')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Images</span></a>
                          </li>
  
                              <li><a class="d-flex align-items-center" href="{{route('advertisement')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Advertisements</span></a>
                          </li>
                         ...
                         <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate text-light" data-i18n="Invoice">Footer Details</span></a>
                      <ul class="menu-content">
                          <li><a class="d-flex align-items-center" href="{{route('about_us')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">About us</span></a>
                          </li>
  
                              <li><a class="d-flex align-items-center" href="{{route('advertisement')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Contact us</span></a>
                          </li>

                            <li><a class="d-flex align-items-center" href="{{route('terms_of_policy')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Tems of us</span></a>
                          </li>
  
                              <li><a class="d-flex align-items-center" href="{{route('faq_page')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">FAQ</span></a>
                          </li>
                           <li><a class="d-flex align-items-center" href="{{route('privacy_policy')}}"><i
                                      class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate text-light"
                                      data-i18n="Invoice List">Privacy Plicy</span></a>
                          </li>
