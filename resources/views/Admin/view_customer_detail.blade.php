...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('user_accounts') }}">Customer Accounts </a></h1>
                           
                            </div>

                            <div  class = "cu_header row mx-1 mt-1">
                            <div class = "col-6 px-0 header-cu">
                            <a href = "{{route('user_account', $user_account->id)}}">
                            <h1 class = "cu_active">Profile Details</h1>
                            </a>

                            </div>
                            <div class = "col-6 px-0 header-cu">
                            <a href = "{{route('tendor_req', $user_account->id)}}">
                            ...
                            <form action = "{{route('change_status', $user_account->id)}}" method = "POST">
                            @csrf
                            <div class = "row border m-2">
                            <div class = "col-sm-4 mt-2 acc-head">
                            <p>Account Status</p>
                            </div>
                                <div class = "col-sm-4 mt-1  status_select">
                                <select name = "account_status"  class="form-control">
                                @if($user_account->account_status == 0)
                                ...
                                <div class = "col-sm-4 mt-1 update_status">
                            <button type="submit" class="btn btn-primary">Update Status</button>
                             ...
                             <div class="pack-edit ml-2 mt-1">
                                <a href = "{{route('edit_customer',$user_account->id )}}">
                                ...
                                <div class = "row mx-2 mt-1">
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px;">{{$user_account->name}} {{$user_account->lname}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <p style = "margin-top:6px; ">{{$user_account->email}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->number}}</p>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-4 mt-1 col-form-label">Address 1</label>
                                 <div class="col-sm-8 ">
                                 <p style = "margin-top:18px; ">{{$user_account->address_1}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->address_2}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row mx-2 mt-1">
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->city}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->state}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p style = "margin-top:6px; ">{{$user_account->zip}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
