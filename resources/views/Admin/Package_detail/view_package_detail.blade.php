...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('PackageDetail') }}">back </a></h1>
                                ...
                                <div class="pack-head  m-2">
                                    <h1 class = "text-primary "> {{$view_package->package_name}} Details</h1>
                                    
                                    <a class="btn btn-primary" href="{{ route('store_package') }}"> Add Package</a>
                                ...
                                <div class = "row m-1">
                                  ...
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Package Name</label>
                                 <div class="col-sm-6">
                                 <input type="text" value = "{{$view_package->package_name}}" readonly  class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Business Listing</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->bussiness_listing}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Product Listing</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->product_listing}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Gallery Images</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->gallery_image}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Company Profile</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->company_profile}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Contact</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->contact}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row m-1">
                                 ...
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->location}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Social Media</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->social_media}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Priority Listing</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->priority_listing}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Probuild Verification</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->probuild_verify}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Tener Board</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->tendor_board}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Validity</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->validity}} Months" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="col-sm-6 ">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Price</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$view_package->price}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                               ...
                               <div class = "row  mb-1">
                                  <div class="col-sm-12 ">
                                    ...
                                    <div class="pack-head m-2">
                                    <h1 class = "text-primary "> Package Members</h1>
  ...
  <tbody>
  @foreach($data as $vendorchild)
  
    <tr>
       <td>{{$vendorchild->id}}</td>
      <th>{{$vendorchild->name}} {{$vendorchild->lname}}</th>
      <td>{{$vendorchild->email}}</td>
      <td>{{$vendorchild->ends_date}}</td>
    </tr>
