                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                          <a class="  action" href="{{ route('edit_package',$package->id ) }}"><i class="fas fa-edit"></i> </a>
                                               

                                          <form method="POST" id="delete-form-{{ $package->id }}"
                                            action="{{ route('delete_package',$package->id) }}"
                                            style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                                        ...
                                        document.getElementById('delete-form-{{ $package->id }}').submit();
                                        ...
                                        else
                                         {
                                          ...
                                          <td>
                                           <a href = "{{route('view_package_detail', $package->id)}}" >
