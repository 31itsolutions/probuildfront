                ...
                <div class="mt-3">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fname" id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lname" id="exampleInputEmail1"  placeholder="">
                                  </div>           
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"  class="form-control" name="mobile" id="exampleInputEmail1"  placeholder="">
                                  </div>                               
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="password"  class="form-control" name="pwd" id="exampleInputEmail1"  placeholder="">
                      </div>
                      </div>
                      <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="address_1" id="exampleInputEmail1"  placeholder="">
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="address_2" id="exampleInputEmail1"  placeholder="">
                      </div>
                      </div>
                      <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="state" id="exampleInputEmail1"  placeholder="">
                      </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="city" id="exampleInputEmail1"  placeholder="">
                      </div>
                      </div>
                      <div class = "col-sm-6">
                        ...
                        <input type="text"  class="form-control" name="zip" id="exampleInputEmail1"  placeholder="">
                      </div>
                    ...
                    @foreach ($package_detail as $package_name_detail)
                        
                    <option value = "{{$package_name_detail->id}}">{{$package_name_detail->package_name}}</option>
