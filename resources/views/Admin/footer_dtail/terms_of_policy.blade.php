            ...
            <div class="m-2">
                ...
                <div class="mt-3">
                    <form action="{{ route('store_vendor') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title" class="form-control" name="fname" id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                        </div>
                        ...
                        <textarea class="form-control" name = "title_description" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                            </div>
                        </div>
