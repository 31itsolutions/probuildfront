        ...
        <div class="col-md-12 ">
         ...
         <h1><a class="" href="{{ route('admin.home') }}">Home</a> </h1>
            ...
            <div class="m-2">
                ...
                <div class="mt-3">
                    <form action="{{ route('update_about_us') }}" method="POST" >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title" class="form-control" name="fname" required id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                        </div>
                        ...
                        <textarea class="form-control" name = "title_description" id="exampleFormControlTextarea1" required rows="3"></textarea>
                        </div>
                            </div>
                        </div>


                                    <button type="submit" class="btn btn-sm btn-primary add_bu glow mt-2  md-2 mb-1 r-0">
