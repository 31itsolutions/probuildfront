...
<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value = "{{$admin->name}}" id="exampleInputEmail1"  placeholder=" ">
                                  </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" value = "{{$admin->email}}" id="exampleInputEmail1"  placeholder="">
                                  </div>           
                            </div>
                        </div>
  ...
  <div class = "row">
                        ...
                        <div class = "">
                               ...
                               <input type="file" class="custom-file-input" name = "profile_image" id="validatedCustomFile" >
                               ...
                               @else
                              <img class="header-img mt-2" width = "150px" height = "100px" src="{{asset('storage/admin_profile/'. $admin->profile)}}">
                               @endif
                                                   ...
                                                   <button class="btn btn-sm btn-primary glow mt-md-2 mb-1">Update Details</button>
