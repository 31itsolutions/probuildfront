                                ...
                                <div class="table-">
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($user_accounts as $key => $item)
                                          ...
                                          <tr>
                                            ...
                                            value="{{$item->id}}"  onchange="change_status(this.value, 'customers', '#customSwitchGlow{{$key}}', 'id');" id="customSwitchGlow{{$key}}" >
                                            <label class="custom-control-label" for="customSwitchGlow{{$key}}">
                                                          ...
                                                          <td>
                                           <a href = "{{route('user_account', $item->id)}}" >
