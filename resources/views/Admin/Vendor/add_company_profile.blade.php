  ...
  <div class="pack-head   ml-2">
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "business_title"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-12">
                                 ...
                                 <div class="">
                                 <input type="text" style = "height:70px;" name = "business_description"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
  ...
  <div class="pack-head   ml-2">
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "area"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "province"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "country"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 ...
                                 <div class="">
                                 <input type="text"  name = "lat"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
                        ...
                        <div class = "col-md-12">
                                 ...
                                 <div class="">
                                 <input type="text"  name = "lang"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
  ...
  <div class="pack-head   ml-2">
             ...
             <div class="form-group row mx-1" >
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "mobile"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "website"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 ...
                                 <div class="">
                                 <input type="text"  name = "fax_no"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
  ...
  <div class="pack-head   ml-2">
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "instagram"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "twitter"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
             ...
             <div class="form-group row mx-1" >
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "linkedin"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 ...
                                 <div class="">
                                 <input type="text"  name = "facebook"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
