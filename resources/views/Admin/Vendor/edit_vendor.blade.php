...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_accounts') }}">Vendor Accounts </a>
                              <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_account',$vendor_account->id ) }}">back </a></h1>
                     ...
                     <form action="{{ route('update_vendor',$vendor_account->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class = "row m-1">
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "fname" value = "{{$vendor_account->name}} "   class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "lname"  value = "{{$vendor_account->lname}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text"  name = "email" value = "{{$vendor_account->email}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  <div class="col-sm-6 ">
   ...
   <input id="phone" name  = "mobile"  value = "{{$vendor_account->number}}"  class = "form-control" type="tel">
   ...
   <span id="error-msg" class="hide">Invalid number</span>
                    ...
                    <input type="file" name = "vendor_profile" onChange="dragNdrop(event)"  ondragover="drag()" ondrop="drop()" id="uploadFile"  />
                     ...
                     <div class = "image_cu"  id="preview"></div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "add_1" value = "{{$vendor_account->address_1}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text"  name = "area" value = "{{$vendor_account->address_2}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row m-1">
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "province"  value = "{{$vendor_account->city}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "country"  value = "{{$vendor_account->state}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text"  name = "zip" value = "{{$vendor_account->zip}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
