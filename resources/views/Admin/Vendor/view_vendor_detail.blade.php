...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('vendor_accounts') }}">Vendor Accounts </a></h1>
                            ...
                            <h1 class = "cu_active">Profile Details</h1>
                            </a>
                            ...
                            <form action = "{{route('change_account_status', $vendor_account->id)}}" method = "POST">
                            @csrf
                            <div class = "row mx-2">
                            <div class = "col-md-6 border ">

                             <p class = "pt-1"><b>Change Account Status</b></p>
                            ...
                            <p>Account Status</p>
                                ...
                                @if($vendor_account->account_status == 0)
                                 <option selectedvalue = "0">de-active</option>
                                 @else
                                 <option selectedvalue = "1">active</option>
                                 @endif
                          ...
                          <div class = "row">
                            <div class = "col-sm-12">
                           <div class = "ml-0 mt-1 update_status">
                            <button type="submit" class="btn btn-primary">Update Details</button>
                             ...
                             <p class = "pt-1"><b>Change package</b></p>

                             
                           <form action = "{{route('change_package_details', $vendor_account->id)}}" method = "POST">
                            @csrf                             
                            <div class = "row ">
                            <div class = "col-sm-6 mt-0 acc-head">
                            <p>Package Details</p>
                            </div>
                                <div class = "col-sm-6 mb-1  status_select">
                                <select name = "package_update"  class="form-control">
                                 <option selected value = "0">Choose Package...</option>
                                 @foreach($package as $package_child)
                                <option value = "{{$package_child->id}}">{{$package_child->package_name}}</option>
                                @endforeach
                                </select>
                            </div>
                            </div>
                           ...
                           <div class = "mr-1 mb-1 update_status">
                            <button type="submit" class="btn btn-primary">Update Details</button>
                            </div>
                            </div>
                             ...
                             <div class="pack-edit ml-2 mt-2">
                                <a href = "{{route('edit_vendor',$vendor_account->id )}}">
                                ...
                                <div class = "row mx-2 ">
                                  ...
                                  <label for="staticEmail" class="col-sm-4 col-form-label">Vendor Name</label>
                                 <div class="col-sm-8">
                                <p  style = "margin-top:6px; ">{{$vendor_account->name}} {{$vendor_account->lname}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                <p  style = "margin-top:6px; ">{{$vendor_account->email}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <p  style = "margin-top:6px; ">{{$vendor_account->number}}</p>
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-4 col-form-label">Package Status</label>
                                 <div class="col-sm-8">
                                 @if($package_info == true)
                                 <p style = "margin-top:6px; "> {{$plan_detail->package_name}} (
                                 ...
                                 @elseif($package_info == false)

                                 <input type="text" readonly value = "Package Expired" class="form-control-plaintext" id="staticEmail" >
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">{{$vendor_account->address_1}}</p>
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">{{$vendor_account->address_2}}</p>
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row mx-2 mt-1">
                                  <div class="col-sm-6 px-0">
                                       <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-4 col-form-label">Province</label>
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">{{$vendor_account->city}}</p>
                                 </div>
                                 </div>
                                   </div>
                                ...
                                <p style = "margin-top:6px; "> India</p>
                                  ...
                                  <div class="col-sm-6 px-0">
                                            ...
                                            <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-4 col-form-label">Zip</label>
                                 <div class="col-sm-8">
                                <p style = "margin-top:6px; ">638 111</p>
                                 </div>
                                 </div>
                                   </div>
                            ...
                            <div class = "col-sm-6 ">
                               ...
                               <input type="file" class="custom-file-input" name ="vendor_document" id="validatedCustomFile" >
                    ...
                    <select name = "verified_vendor" class="form-control">
