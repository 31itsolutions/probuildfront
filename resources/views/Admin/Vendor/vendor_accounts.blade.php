...
License: You must have a valid license purchased only from themeforest(the above link) in order to legally vendorthe theme for your project.
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, vendor-scalable=0">
    ...
    <link rel="stylesheet" href="https://vendorfontawesome.com/releases/v5.0.13/css/all.css"
...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12 card ">
                                  ...
                                  <div class = "back-option ml-0 mt-1">
                                ...
                                <div class="table-">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($vendor_accounts as $key => $item)
                                          ...
                                          <tr>
                                            ...
                                            <input type="checkbox" class="custom-control-input" {{$item->account_status == 1 ? 'checked' : ''}}
                                            value="{{$item->id}}"  onchange="change_status(this.value, 'vendors', '#customSwitchGlow{{$key}}', 'id');" id="customSwitchGlow{{$key}}" >
                                            <label class="custom-control-label" for="customSwitchGlow{{$key}}">
                                            </label>
                                        </div>
                                               </td>
                                                 <td>
                                           <a href = "{{route('vendor_account', $item->id)}}" >
