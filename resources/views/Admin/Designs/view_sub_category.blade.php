...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "card">
                      ...
                      <div class = "back-option ml-1 mt-1">     
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('sub_category') }}">Add Sub Category  </a> </h1>
...
<div class="custom-control custom-switch custom-switch-glow custom-control-inline">
    <input type="checkbox" class="custom-control-input" {{$item->premium == 1 ? 'checked' : ''}}
    value="{{$item->id}}"  onchange="change_status(this.value, 'sub_categories', '#customSwitchGlow{{$key}}', 'id');" id="customSwitchGlow{{$key}}" >
