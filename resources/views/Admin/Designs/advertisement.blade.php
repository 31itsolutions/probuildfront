...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row">
                        <div class="col-md-12 card">
                            ...
                            <form action="{{route('update_advertisement')}}" method="POST"
                                ...
                                <div class="m-2">
                                    ...
                                    <div class="pack-head ">
                                        <h1 class="text-primary">Update Images</h1>
                                    </div>

                                    <div class="m-1 mb-1">
                                        <div class="">
                                            <div class="pack-head d-flex">
                                                <h1>Advertisements Banner Top</h1>
                                            </div>

                                            <div class="mt-1 view_edit r-0 b-3">
                                                @if($add_image1 >0)

                                                <a class="" data-toggle="modal" data-target="#exampleModalCenter"
                                                    href=""><i class="fa fa-eye" aria-hidden="true"></i> </a>
                                                ...
                                                <div class="modal fade" id="exampleModalCenter" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content ">
                                                            <div class="ml-1 mr-4 mt-1 mb-2">

                                                                <div class='row'>


                                                                    @foreach ($get_add_image as $get_add_image_child)
                                                                    <div class="col-md-4">

                                                                        <img class="header-img mx-1 mt-1 rounded"
                                                                            width="150px" height="100px"
                                                                            src="{{asset('storage/advertisement_images/'. $get_add_image_child->add_image)}}">
                                                                    </div>
                                                ...
                                                <a href="{{ route('edit_advertisement') }}"> <i class="fas fa-edit"></i> </a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="add_image"
                                                            id="validatedCustomFile">
                                                        <label class="custom-file-label"
                                                            for="validatedCustomFile">Choose Image...</label>
                                            ...
                                            <p class="mt-2">{{$add_image1}} Images Added</p>
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary glow ml-1 mt-md-2 mb-1">Update
                                        images</button>
                            ...
                            <form action="{{route('update_advertisement_next')}}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="m-1 mt-1 ">
                                    <div class="">
                                        <div class="pack-head">
                                            <h1>Advertisements Banner Middle</h1>
                                        ...
                                        <div class="mt-1 view_edit r-0 b-3">
                                            ...
                                            <a class="" data-toggle="modal" data-target="#exampleModalCenter" href=""><i
                                                    ...
                                                    <div class="modal-content ">
                                                        <div class="ml-1 mr-4 mt-1 mb-2">
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                @foreach ($get_add_image_next as
                                                                $get_add_image_next_child)
                                                                <div class="col-md-4">

                                                                    <img class="header-img mx-1 mt-1 rounded"
                                                                        width="150px" height="100px"
                                                                        src="{{asset('storage/advertisement_images/'. $get_add_image_next_child->add_image_next)}}">
                                                                </div>
                                            ...
                                            <a href="{{ route('edit_advertisement_next') }}"> <i class="fas fa-edit"></i> </a>
                                        ...
                                        <p class="mt-2">{{$add_image2}} Images Added</p>
