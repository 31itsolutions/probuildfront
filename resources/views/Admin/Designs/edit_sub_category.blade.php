...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "col-md-12">
                     ...
                     <form action="{{ route('update_edited_sub_category', $sub_category->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class = "card">
                      ...
                      <div class = "back-option ml-1 mt-1">     
                        ...
                        <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('view_sub_category') }}">View Sub Category  </a></h1>
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                        ...
                        <div class = "col-md-6">
                                  <label for="staticEmail" class="col-form-label">Sub Category Name</label>
                                 <div class="">
                                 <input type="text" name = "sub_category" value = "{{$sub_category->sub_category}}"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                                             ...
                                             {{-- <div class="form-group row"> --}}
                                                <div class = "col-md-6">
                                                          <label for="staticEmail" class="col-form-label">Sub Category Icon</label>
                                                         <div class="">
                                                            <div class="custom-file">
                                                                <input name = "sub_category_icon" type="file" class="custom-file-input" id="customFile">
                                                                <label class="custom-file-label" for="customFile">{{$sub_category->sub_category_icon}}</label>
                                                                <small id="emailHelp" class="form-text text-muted">Icon size : 29.21x24</small>
                                          ...
                                          <div class="form-group row">
                        <div class = "col-md-6">
                                  <label for="staticEmail" class="col-form-label">Sub Category Description</label>
                                 <div class="">
                                 <input type="text" name = "sub_category_description" value = "{{$sub_category->sub_category_description}}"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}

                                                {{-- <div class="form-group row"> --}}
                                                                        <div class = "col-md-6 priority_input">

                                                        <label for="inputPassword6"> Category Type</label>
                                                                    
                                                                <select name="category_type"  id="inputState"class="form-control">
                                                                    <option  >{{$sub_category->category_type}}</option>
                                 ...
                                 <div class="row ">
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="inputPassword6">Priority listing</label>
                                                                    
                                                                <select name="priority"  id="inputState"class="form-control">
                                                                    <option  >{{$sub_category->priority}}</option>
                                       ...
                                       <button  type = "submit" class="btn btn-sm btn-primary glow mt-md-2 ">Update Details</button>
