...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                                ...
                                @if($category_count >0)
                                <a href = "{{route('view_category')}}" class = "text-primary">View & Edit</a>
                                @endif
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "category_description"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
