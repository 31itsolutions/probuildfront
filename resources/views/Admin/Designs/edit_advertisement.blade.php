...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "col-md-12 card">
                        <div class = "back-option ml-1 mt-1">     
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('advertisement') }}">Add Advertisements </a> </h1>
                        ...
                        @csrf
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label"
                                        for="validatedCustomFile">{{ $item->add_image }}</label>
                            ...
                            <div class="col-sm-6">
                                ...
                                src="{{asset('storage/advertisement_images/'. $item->add_image)}}">
