...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "m-2">
                        ...
                        <div class = "">
                               ...
                               <input type="file" class="custom-file-input" name = "login_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">Choose Image...</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 1440x618</small>
                              ...
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('assets/images/'. $image->login_image)}}">
                               @endif
                        ...
                        <div class = "">
                                ...
                                <div class = "col-sm-12">
                               <div class="custom-file">
                               <input type="file" class="custom-file-input" name = "home_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">Choose Image...</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 4096x2731</small>
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                    ...
                                    @if($image_check==true)
                               <p class = "mt-2">Current image</p>
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('assets/images/'. $image->home_image)}}">
                        ...
                        <div class = "">
                                ...
                                <div class = "col-sm-12">
                               <div class="custom-file">
                               <input type="file" class="custom-file-input" name = "vendor_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">Choose Image...</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 4096x2731</small>
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                    ...
                                    @if($image_check==true)
                               <p class = "mt-2">Current image</p>
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('assets/images/'. $image->vendor_image)}}">
                        ...
                        <div class = "">
                                ...
                                <div class = "col-sm-12">
                               <div class="custom-file">
                               <input type="file" class="custom-file-input" name = "customer_image" id="validatedCustomFile" >
                                  <label class="custom-file-label" for="validatedCustomFile">Choose Image...</label>
                                  <small id="emailHelp" class="form-text text-muted">Icon size : 4096x2731</small>
                               ...
                               <div class="invalid-feedback">Example invalid custom file feedback</div>
                                    ...
                                    @if($image_check==true)
                               <p class = "mt-2">Current image</p>
                              <img class="header-img" width = "150px" height = "100px" src="{{asset('assets/images/'. $image->customer_image)}}">
                  ...
                  <button class="btn btn-sm btn-primary glow ml-3 mt-md-2 mb-1">Update images</button>
