                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                <div class="user-nav d-sm-flex d-none"><span class="user-name">Admin</span></div><span><img class="round"
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <li class=" nav-item"><a href="{{ route('admin.home') }}"><i class="" data-icon="envelope-pull"></i><span
                    class="menu-title text-truncate" data-i18n="User">Home</span></a>
                </li>
                  ...
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate" data-i18n="Invoice">Category</span></a>
                  ...
                  <li class=" nav-item"><a href="{{ route('create_vendor') }}"><i class="" data-icon="check-alt"></i><span
                              class="menu-title text-truncate" data-i18n="Vendor">Add Vendor</span></a>
                  </li>
             
  
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate" data-i18n="Invoice">Manage Accounts</span></a>
                      <ul class="menu-content">
                  ...
                  <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate" data-i18n="Invoice">Package Details</span></a>
                      <ul class="menu-content">
                         ...
                         <li class=" nav-item"><a href="#"><i class="" data-icon="notebook"></i><span
                              class="menu-title text-truncate" data-i18n="Invoice">Update Design</span></a>
                      <ul class="menu-content">
                ...
                <section id="dashboard-ecommerce">
                    ...
                    <div class = "card">
                      ...
                      <div class = "back-option ml-1 mt-1">     
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> </h1>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
           ...
           <a class="  action" href="{{ route('edit_category',$item->id ) }}"><i class="fas fa-edit"></i> </a>


       <form method="POST" id="delete-form-{{ $item->id }}"
                                            action="{{ route('delete_category',$item->id) }}"
                                            style="display: none">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
                                        ...
                                        <a class="  action" onclick="if (confirm('Are you sure want to delete ?')){
                                        ...
                                        document.getElementById('delete-form-{{ $item->id }}').submit();
                                         ...
                                         } " class="action"> <i class="far fa-trash-alt"></i> </i>
                                        </a>
