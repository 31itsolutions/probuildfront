...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "col-md-12">
                     ...
                     <form action="{{ route('update_sub_category') }}" method="POST"  enctype="multipart/form-data" >
                        @csrf
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                                ...
                                @if($category_count >0)
                                <a href = "{{route('view_sub_category')}}" class = "text-primary">View & Edit</a>
                                @endif
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category"  class="form-control" id="staticEmail">
                        ...
                        <div class = "col-md-6">
                                 ...
                                 <div class="">
                                 <input type="text" name = "sub_category_description"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                            ...
                            <label for="inputPassword6"> Premium</label>
                                        
                                    <select  name = "premium"  id="inputState"class="form-control">
