...
@include('Admin.admin_layout.header')
                    ...
                    <div class = "col-md-12">
                     ...
                     <form action="{{ route('update_edited_category', $category_update->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class = "card">
                      ...
                      <div class = "back-option ml-1 mt-1">     
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('view_category') }}">view Category  </a></h1>
                    ...
                    <div class = "m-2">
                       ...
                       <div class="pack-head   mt-1 mb-1">
                        ...
                        <div class = "col-md-6">
                                  <label for="staticEmail" class="col-form-label">Category Name</label>
                                 <div class="">
                                 <input type="text" name = "category" value = "{{$category_update->category}}"  class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 {{-- </div> --}}
                        ...
                        {{-- <div class="form-group row"> --}}
                        <div class = "col-md-6">
                                  <label for="staticEmail" class="col-form-label">Category Description</label>
                                 <div class="">
                                 <input type="text" name = "category_description" value = "{{$category_update->category_description}}"   class="form-control" id="staticEmail">
                                 </div>
                                 </div>
                                 </div>
                        ...
                        <div class="form-group row">
                            <div class = "col-md-6">
                                      <label for="staticEmail" class="col-form-label">Category Icon</label>
                                     <div class="">
                                        <div class="custom-file">
                                            <input name = "category_icon"  type="file" class="custom-file-input" id="customFile">
                                            <label class="custom-file-label" for="customFile">{{$category_update->category_icon}}</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPassword6">Priority listing</label>
                                                                ...
                                                                <select name="priority"  id="inputState"class="form-control">
                                                                    <option >{{$category_update->priority}}</option>
