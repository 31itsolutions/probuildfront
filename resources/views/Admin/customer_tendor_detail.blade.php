...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('user_accounts') }}">User Accounts </a></h1>
                            ...
                            <h1  class = "cu_active">Tender Details</h1>
                            </a>
                                ...
                                <div class = ' date'>
                                <p><span>Date : {{$tendor->updated_at}}</span></p>
                                </div>
                                <div class = "row m-1">
                                  <div class="col-sm-6 ">

                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Tendor Category</label>
                                 <div class="col-sm-6">
                                 <input type="text" value = "{{$tendor->category}}" readonly  class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Tendor End date</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$tendor->end_date}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                  ...
                                  <div class="col-sm-6 ">
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-6 col-form-label">Tendor Description</label>
                                 <div class="col-sm-6">
                                 <input type="text" readonly value = "{{$tendor->tender_description}}" class="form-control-plaintext" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
