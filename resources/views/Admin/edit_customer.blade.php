...
@include('Admin.admin_layout.header')
                    ...
                    <div class="row ">
                            ...
                            <h1><a class="" href="{{ route('admin.home') }}">Home</a> <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('user_accounts') }}">Customer Accounts </a>

                              <i class="fas fa-chevron-right"></i> <a class="" href="{{ route('user_account', $user_account->id) }}">back </a></h1>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="mt-1">
                ...
                @endif
                                ...
                                <div class="pack-head  ml-2 mt-1 mb-1">
                                    <h1>Edit Customer Details</h1>
                                    

                                </div>

                     <form action="{{ route('update_customer',$user_account->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                <div class = "row m-1">
                                  <div class="col-sm-6 ">
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "fname" value = "{{$user_account->name}} "   class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "lname"  value = "{{$user_account->lname}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 <input type="text" name = "email"  value = "{{$user_account->email}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-8">
                                 {{-- <input type="text" name = "mobile"  value = "{{$user_account->number}}" class="form-control" id="staticEmail" value="email@example.com"> --}}
   ...
   <input id="phone"  value = "{{$user_account->number}}" class = "form-control" type="tel">
   ...
   <span id="error-msg" class="hide">Invalid number</span>
                    ...
                    <input type="file" name = "cu_profile" onChange="dragNdrop(event)"  ondragover="drag()" ondrop="drop()" id="uploadFile"  />
                    </span>
                    </div>
                      </div>
                     ...
                     <div class = "image_cu"  id="preview"></div>
                                  ...
                                  <div class="form-group row">
                                  <label for="staticEmail" class="col-sm-3 col-form-label">Address 1</label>
                                 <div class="col-sm-9">
                                 <input type="text"  name = "add_1" value = "{{$user_account->address_1}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "area"  value = "{{$user_account->address_2}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                              <div class = "row m-1">
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "province"  value = "{{$user_account->city}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text" name = "country"  value = "{{$user_account->state}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
                                 ...
                                 <div class="col-sm-9">
                                 <input type="text"  name = "zip" value = "{{$user_account->zip}}" class="form-control" id="staticEmail" value="email@example.com">
                                 </div>
                                 </div>
                                   </div>
                                   </div>
